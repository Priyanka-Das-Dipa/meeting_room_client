      ...
      render: (transformedUser) => {
        ...
        return (
          <div className="flex gap-3 items-center">
            ...
            <Button
              onClick={() => handleDelete(transformedUser._id)}
            ...
            <Button
              onClick={() =>
                handleMakeAdmin(transformedUser?._id, transformedUser?.role)
              }
            >
              {transformedUser?.role === "user" ? "Make Admin" : "Make user"}
            </Button>
          </div>
        );
      },
