...
const CheckOutPage = () => {
  ...
  const eachSlots: string[] | any = [];

  const tableProps = booking?.map((item, idx) => {
    item?.slots?.map((item) => {
      eachSlots.push(item.split(",")[0]);
    });
  ...
  return (
    <div className="container mx-auto h-screen my-16">
        ...
        {booking?.length ? (
          <div className="flex justify-between flex-col md:flex-row gap-3">
            ...
            <div className="my-1 p-2 md:p-4 md:min-w-[400px] text-left shadow">
              ...
              <h2 className="py-1 font-roboto font-semibold mt-2 text-lightText">
                Name: {name}
              </h2>
              <h2 className="py-1 font-roboto font-semibold mt-2 text-lightText">
                Email: {email}
              ...
              <h2 className="py-1 font-roboto font-semibold text-lightText">
